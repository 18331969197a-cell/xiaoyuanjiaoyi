...
public class StorageRegistryService {
    ...
    public boolean loadFromDatabase() {
        ...
        if (loaded) {
            cacheProvider.set(CacheConstants.StorageConfig.CONFIGURATION_FILE_TYPE, CacheConstants.StorageConfig.CONFIG_TYPE_DATABASE);
    ...
    private boolean loadConfig(String storageType, String json) {
        ...
        loader.loadConfig(json, cacheProvider);
        log.info("存储服务 [{}] 配置已加载到缓存.", storageType);
        return true;
    }
}
