...
import cn.zhangchuangla.common.core.property.AppProperty;
...
public class ResourcesConfig implements WebMvcConfigurer {
    ...
    public void addResourceHandlers(@NotNull ResourceHandlerRegistry registry) {
        ...
        configureUploadsAccess(registry);
    }

    /**
     * 配置uploads目录的访问路径（帖子图片等）
     */
    private void configureUploadsAccess(ResourceHandlerRegistry registry) {
    ...
    private void configureLocalFileAccess(ResourceHandlerRegistry registry) {
        registry.addResourceHandler(Constants.RESOURCE_PREFIX + "/**")
                .addResourceLocations("file:" + appProperty.getResolvedUploadPath() + "/");
    }
